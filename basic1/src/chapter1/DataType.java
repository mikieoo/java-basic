...
public class DataType {
	...
	public static void main(String[] args) {
		...
		float float1 = 3.1423849238472938434234F;
		System.out.println(float1);
		
		// double : 8byte(64bit)의 크기를 가지는 실수형 데이터 타입
		// 소수점 15-17자리에서 오차가 발생
		double double1 = 3.1423849238472938434234;
		System.out.println(double1);
		
		// 문자형 테이터 타입 : 문자 하나를 저장할 수 있는 데이터 타입
		...
		// 강제 형변환 : 큰 데이터 타입의 변수를 작은 데이터 타입의 변수에 옮겨 담을 때 발생
		 ...
		 // String : 문자의 배열(문자열)을 표현하는데에 사용되는 참조형 데이터 타입
		 // 선언
		 // String 변수명;
		 // 생성
		 // new String();
		 ...
		 // 2. 문자열 비교
		 // equals(문자열) : 두 문자열이 같은지 비교
		 // compareTo(문자열) : 두 문자열을 사전순으로 비교 (대소문자 구분)
		 // compareToIgnoreCase(문자열) : 두 문자열을 사전순으로 비교 (대소문자 구분X)
		 System.out.println(str.equals("My name is loki"));
		 System.out.println(str.compareTo(" My name is loki "));
		 ...
		 str = "내가 그린 기린 그림은 잘 그린 기린 그림이고";
		 System.out.println(str.indexOf("기린"));
		 System.out.println(str.indexOf("사자"));
		 System.out.println(str.lastIndexOf("기린"));
		 System.out.println(str.lastIndexOf("사자"));
		 ...
		 // 배열, 클래스, 인터페이스, 열거혀이 참조형 데이터 타입에 속함
		 String str2 = null;
