...
class ExampleClass1 {
	...
	static void staticMethod() {
		// System.out.println(attribute1); 인스턴스 필드 사용못함
		// method1(5) // 인스턴스 메서드 사용 못함 오로지 static 만 가능
	}
}
...
class SmartPhone {
	...
	void sendMessage(String toTelNumber, String message) {
		System.out.println(telNumber + "가 " + toTelNumber 
				+ "에게 " + message + "를 전송했습니다.");
	}
...
public class ClassAndObject {
	...
	public static void main(String[] args) {
		...
		ExampleClass1.staticAttribute = 10;
		System.out.println(ExampleClass1.staticAttribute);
		System.out.println(ExampleClass1.staticAttribute);
		
		ExampleClass1.staticAttribute = 33;
		System.out.println(ExampleClass1.staticAttribute);
