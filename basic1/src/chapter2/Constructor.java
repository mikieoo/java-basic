...
class Human1 {
	...
	final String address; // final 로 생성한 변수는 무조건 초기화해야함
	...
	// 생성자를 이용한 인스턴스 복사
	Human1(String name, int age, String gender, String address){
		this.name = name;
		this.age = age;
		this.gender = gender;
...
//		human6.gender = human3.gender;
		...
		Human1 human7 = new Human1("김", 30, "남", "서울");
		System.out.println(human7.name); // 김
		System.out.println(human7.age); // 30
		System.out.println(human7.gender); // 남
		System.out.println(human7.address); // 서울
