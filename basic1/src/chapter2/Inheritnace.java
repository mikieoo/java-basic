...
class SalesMan extends Human {
	...
	// 2. 상위 클래스에서 선언된 메서드가 final 로 선언되며 재정의가 불가능
...
public class Inheritnace {
	...
	public static void main(String[] args) {
		...
		Developer developer1 = new Developer("홀길동", 20, new String[]{"java", "python"}) ;
