...
// 2. 타입 불일치 : 변수의 타입이나 메서드이 반환 타입이 일치하지 않을 때
// 3. 미선언 변수 : 선언되지 않은 변수 혹은 메서드를 사용할 때
...
public class ErrorAndException {
	...
	public static void main(String[] args) throws Exception{
		...
		// 발생할 수 있는 예외 (InputMismatchException)
		// - 사용자가 정수를 입력하지 않았을 때 (ArithmeticException)
		// - 사용자가 0을 입력했을 때
		...
		} catch(Exception e) { // 어떤 예외가 발생할지 모를때 부모인 Exception 사용
