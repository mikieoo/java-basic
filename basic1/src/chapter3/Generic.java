...
public class Generic {
	...
	// 제너릭 메서드 : 메서드의 매개변수의 타입이나 반환 타입을 컴파일시에 결정하고자 할 때 사용
	...
	public static void main(String[] args) {
		...
		// ? super MyClass로 제한이 결렸기 때문에
		// MyClass혹은 MyClass의 부모 클래스만 매개변수로 전달할 수 있음
		superMethod(list4);
		superMethod(list3);
		// superMethod(list5);
		// superMethod(list2);
